...
var NetCMD =
{
     ...
     * 跑胡子
     */
    SERVER_START_BET_BC              : 4034,//押注开始 内外围打鸟
    SERVER_STOP_BET_BC               : 4035,//停止外围押注 停止内外围打鸟
    SERVER_BETTING_ERR_UC            : 4037,//押注失败 打鸟
    SERVER_BETTING_SUCC_UC           : 4027,//押注成功 打鸟
    ...
    SERVER_PHZ_OPERATE_RES      : 6007,         //操作响应
    SERVER_PHZ_UPDATE_ABANDON_CARD      : 6008,         //更新弃牌记录
    SERVER_PHZ_START_PIAO      : 6009,         //开始飘
    SERVER_PHZ_PIAO_SUCC      : 6010,         //飘成功
    SERVER_PHZ_PIAO_ERR      : 6011,         //票失败
    SERVER_PHZ_XIANG_GONG      : 6012,         //相公
    SERVER_PHZ_FINAL_END_RES      : 6100,         //最终结算请求
    SERVER_PHZ_PRE_OPERATE_RES      : 6013,         //预操作响应
    SERVER_PHZ_PRE_OPERATE_NOTIFY     : 6014,         //预操作通知
    SERVER_PHZ_OFFLINE_INFO_RES     : 6015,         //断线信息返回
    SERVER_PHZ_OFFLINE_INFO_ERR     : 6016,         //断线信息错误通知

    CLIENT_PHZ_OFFLINE_INFO_REQ           : 1306, //断线信息请求

    CLIENT_PHZ_FINAL_END_REQ           : 1400, //最终结算返回
    CLIENT_PHZ_PIAO_REQ           : 1304, //飘请求
    CLIENT_BETTING_REQ           : 1015, //打鸟请求
    CLIENT_PHZ_OUT_CARD_REQ      :1300,         //出牌命令
    CLIENT_PHZ_PRE_OPERATE_REQ :1305,         //预操作
    CLIENT_PHZ_OPERATE_CARD_REQ :1301,         //操作扑克
    CLIENT_PHZ_CHANGE_CARD_REQ   : 1302,            //请求交换扑克
    CLIENT_PHZ_UPDADE_CARD_REQ   : 1303,          //请求更新扑克
