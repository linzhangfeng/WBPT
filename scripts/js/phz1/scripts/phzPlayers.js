...
var PHZPlayer =
{
    ...
    updateSeatID:function(seatID)
    {
        ...
        this.getUI("coin").setString("总"+(this.player.money-PHZModel.roomGolden));
...
var PHZPlayers =
{
    ...
    downtable:function(pos)
    {
        ...
        this.players[pos].reset();
        this.setFZ(pos,false);
        this.players[pos].show(false);
        PHZTips.hideHuxi(pos,-1);
    ...
    updateInfo:function(pos)
    {
        ...
        this.players[pos].getUI("coin").setString("总"+(this.players[pos].player.money-PHZModel.roomGolden));
    },
    getSex:function(pos)
    {
        if(pos<0 || pos >3)
        ...
        return  (this.players[pos].player&&this.players[pos].player.sex ==1) ?"m":"f";
    },
    ...
    setReady:function(pos,is)
    {
        ...
        this.players[pos].getUI("ready").setPosition(p);
