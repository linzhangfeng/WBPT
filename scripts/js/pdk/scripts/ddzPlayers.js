...
var DDZPlayers =
{
    ...
    reset:function(pos)
    {
        if(pos == null)
        {
            for(var i =0 ; i < 3;++i) {
                ...
                DDZTips.showsplitReadyTip(i,false);
            }
        }
        else
        {
            ...
            DDZTips.showsplitReadyTip(pos,false);
        }
    },
    //上桌
    ...
    setReady:function(pos,is)
    {
        ...
        DDZTips.showsplitReadyTip(pos,is);
    ...
    getSex:function(pos)
    {
        ...
        return  (this.players[pos].player!=null&&this.players[pos].player.sex ==1) ?"m":"f";
    },
    getSex1:function(pos)
    {
        ...
        return   (this.players[pos].player!=null&&this.players[pos].player.sex ==1) ?"m":"w";
    },
    ...
    playersNum:function()
    {
        ...
        for(var i in this.players)
        {
            if(this.players[i].uiNode.isVisible() && this.players[i].player.ready==1)
            {
                num++;
            }
        }
