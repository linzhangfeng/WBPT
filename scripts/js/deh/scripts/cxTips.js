...
var CXTips =
{
    ...
    init:function()
    {
        ...
        this.gametip.push(this.getUI("t1"));
        this.gametip.push(this.getUI("t2"));
        this.gametip.push(this.getUI("t3"));
        this.gametip.push(this.getUI("t4"));
        this.gametip.push(this.getUI("t5"));
        this.gametip.push(this.getUI("t6"));

        this.showUIs(this.gametip,false);

        this.pyan = this.getUI("pyan");
    ...
    showGameTip:function(t1,t2,t3)
    {
        if(t1 != 0)
        {
            if(t1 == 1)
            {
                this.getUI("t4").setVisible(true);
            }
            else if(t1 == 2)
            {
                this.getUI("t3").setVisible(true);
            }
        }
        ...
        if(t2 != 0)
        {
            if(t2 == 1)
            {
                this.getUI("t1").setVisible(true);
            }
            else if(t2 == 2)
            {
                this.getUI("t2").setVisible(true);
            }
        }
        ...
        if(t3 != 0)
        {
            if(t3 == 1)
            {
                this.getUI("t6").setVisible(true);
            }
            else if(t3 == 2)
            {
                this.getUI("t5").setVisible(true);
            }
        }

        utils.sortNodes(this.gametip,640,430,10);
    },
