  ...
  spriteFrame:function(key)
{
   return cc.spriteFrameCache.getSpriteFrame(key);
    ...
    getFpStartPos:function()
    {
        return cc.p(965-47,660-55);
    },
    ...
    getCardPos:function(players,pos,cardIndex)
    {
         ...
         var leftdistance_two = 100;
         var rightdistance = -100;
         var rightdistance_two = -100;
         var myintable = 100;

        if(pos == 0)
        {
            cc.pAddIn(Play_position,cc.p(myintable+cardIndex*cins,0));
        }
        else if(pos == 1)
        {
            cc.pAddIn(Play_position,cc.p(rightdistance-cardIndex*cins,0));
        }
        else if(pos == 2)
        {
            cc.pAddIn(Play_position,cc.p(rightdistance_two-cardIndex*cins,0));
        }
        else if(pos == 3)
        {
            cc.pAddIn(Play_position,cc.p(myintable+cardIndex*cins,0));
        ...
        {
            cc.pAddIn(Play_position,cc.p(leftdistance+cardIndex*cins,0));  
        }
        else if(pos == 5)
        {
            cc.pAddIn(Play_position,cc.p(leftdistance_two+cardIndex*cins,0));
        }
    ...
    getSplitCardPos:function(players,pos,cardIndex)
    {
        var Play_position = players.getChildByName("player"+pos).getPosition();
         ...
         if(pos == 0)
        {
            cc.pAddIn(Play_position,cc.p(myintable+index*cins,-30));
        }
        else if(pos == 1)
        {
            cc.pAddIn(Play_position,cc.p(rightdistance-index*cins,-70));
        }
        else if(pos == 2)
        {
            cc.pAddIn(Play_position,cc.p(rightdistance_two-index*cins,-10));
        }
        else if(pos == 3)
        {
            cc.pAddIn(Play_position,cc.p(leftdistance_two+index*cins,-80)); 
        }
        else if(pos == 4)
        {
            cc.pAddIn(Play_position,cc.p(leftdistance_two+index*cins,-10)); 
        }
        else if(pos == 5)
        {
            cc.pAddIn(Play_position,cc.p(leftdistance+index*cins,-70));  
        }
    ...
    getChipStartPos:function(pos,playpostion)
    {
        ...
        if(pos == 0)
        {
            // cc.pAddIn(posv,cc.p(-40,130));  
            cc.pAddIn(posv,cc.p(-180,-10));
        }
        else if(pos == 1)
        {
            cc.pAddIn(posv,cc.p(-350,-10));  
        }
        else if(pos == 2)
        {
            cc.pAddIn(posv,cc.p(-350,-10));  
        ...
        {
            // cc.pAddIn(posv,cc.p(-40,-180));
            cc.pAddIn(posv,cc.p(-180,-10));
        }
        else if(pos == 4)
        {
            cc.pAddIn(posv,cc.p(280,-10));
        }
        else if(pos == 5)
        {
            cc.pAddIn(posv,cc.p(280,-10));   
    ...
    getChipEndPos:function(pos,playpostion)
    {
        ...
        {
            // cc.pAddIn(posv,cc.p(40,180));  
            cc.pAddIn(posv,cc.p(-120,40));
        }
        else if(pos == 1)
        {
            cc.pAddIn(posv,cc.p(-270,40));  
        }
        else if(pos == 2)
        {
            cc.pAddIn(posv,cc.p(-270,40));
    ...
    getBetMoneyBgPos:function(players,pos)
    {
        ...
        if(pos == 0)
        {
            // cc.pAddIn(betBgPos,cc.p(0,110)); 
            cc.pAddIn(betBgPos,cc.p(-150,-40)); 
        }
        else if(pos == 1 )
        {
            cc.pAddIn(betBgPos,cc.p(-320,-40));  
        }
        else if(pos == 2)
        {
            cc.pAddIn(betBgPos,cc.p(-320,-40));   
