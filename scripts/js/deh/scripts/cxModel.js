...
var CXModel =
{
    ...
    teshu_select:0,
    dijiuwang_select:0,
    first_hand_select:0,  // 先手（1 有，2 无）
...
//*********************动态数据处理************************///
    ...
    reset :function()
    {
        ...
        this.allPlayerChips = 0;

        this.teshu_select = 0;

        this.dijiuwang_select = 0;

        this.first_hand_select = 0;

        this.resetDialogView();
    },

    resetDialogView:function()
    {
 ...
 //*********************联网协议处理************************///
    ...
    sendLogin:function()
    {
        ...
        d.data["vid"]  = CXModel.roomData["gameRoom"]["gameId"];
        this.sendData(d.toStr());
    },
