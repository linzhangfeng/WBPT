  ...
  spriteFrame:function(key)
{
   return cc.spriteFrameCache.getSpriteFrame(key);
    ...
    getCardPos:function(players,pos,cardIndex)
    {
         ...
         var flag = CXModel.isMyInTable();
         var maxplayerflag =  CXModel.isPlayer_max();
         var cins = 35;
         var leftdistance = -20;
         var rightdistance = -60;
         var myintable = -40;

         if(flag || !maxplayerflag)
         {
             if(pos == 0)
             {
                cc.pAddIn(Play_position,cc.p(myintable+cardIndex*cins,120));
             }
             else if(pos == 1 || pos == 2)
             {
                cc.pAddIn(Play_position,cc.p(rightdistance+cardIndex*cins,-140));
             }
             else if(pos == 3 )
             {
                cc.pAddIn(Play_position,cc.p(myintable+cardIndex*cins,-140));  
             }
             else if(pos == 4 || pos == 5)
             {
                cc.pAddIn(Play_position,cc.p(leftdistance+cardIndex*cins,-140));
             }
         }
         else
         {
    ...
    getSplitCardPosForSpecialCard:function(players,pos,cardIndex)
    {
        var Play_position = players.getChildByName("player"+pos).getPosition();
        var flag = CXModel.isMyInTable();
        var maxplayerflag =  CXModel.isPlayer_max();
         ...
         if(flag || !maxplayerflag)
         {
            if(pos == 0)
             ...
             if(cardIndex>1)
             {
                cc.pAddIn(Play_position,cc.p(120,0));
             }
         }
         else
         {
        ...
        var maxplayerflag =  CXModel.isPlayer_max();
         ...
         if(flag || !maxplayerflag)
         {
            if(pos == 0)
             ...
             if(cardIndex>1)
             {
                cc.pAddIn(Play_position,cc.p(60,0));
             }
         }
         else
         {
    ...
    getChipStartPos:function(pos,playpostion)
    {
        ...
        if(flag || !maxplayerflag)
        {
            if(pos == 0)
            {
                cc.pAddIn(posv,cc.p(80,-35));  
            }
            else if(pos == 1 || pos == 2)
            {
                cc.pAddIn(posv,cc.p(-160,-35));  
            }
            else if(pos == 3)
            {
               cc.pAddIn(posv,cc.p(80,-35));   
    ...
    getBetMoneyBgPos:function(players,pos)
    {
        ...
        if(flag || !maxplayerflag)
        {
            if(pos == 0)
            {
                cc.pAddIn(betBgPos,cc.p(125,-65));  
            }
            else if(pos == 1 || pos == 2)
            {
                cc.pAddIn(betBgPos,cc.p(-125,-65));  
