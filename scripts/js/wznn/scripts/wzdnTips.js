...
var WZDNTips =
{
    ...
    showThink:function(pos,v)
    {
        ...
        if(v)
        {
            ...
            var player = WZDNModel.getPlayerByPos(pos);
    ...
    showWinCoin:function(pos,num)
    {
        ...
        label.setAnchorPoint(cc.p(0.5, 0.5));
        this.uiNode.addChild(label, 20000);
        var pn = WZDNPlayers.players[pos].uiNode;
        label.setPosition(cc.p(pn.getPosition().x , pn.getPosition().y+pn.getContentSize().height*0.5- 10));
    ...
    notifyChat:function(str)
    {
        ...
        var p = WZDNModel.getPlayerByUID(uid);
        ...
        if(p&&p.seatid !=-1)
        {
            this.showChat(WZDNModel.getPosBySeatID(p.seatid),content);
    ...
    showChat:function(pos,content)
    {
        ...
        var p = WZDNPlayers.getPosition(pos);
        if (pos == 0)
        {
