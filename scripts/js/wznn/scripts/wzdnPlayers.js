...
var WZDNPlayer =
{
    ...
    init:function(seatID)
    {
        ...
        this.uiNode.addClickEventListener(function (sender, evt) {
            ...
            if(WZDNModel.isMySeatID(self.seatID))
            {
            ...
            else
            {
                ...
                {
                    var box = new WZDNBigfaceBox();
                    box.showPos(WZDNModel.getPosBySeatID(self.seatID));
    ...
    doActionPnum:function(num)
    {
        ...
        var _sprite = cc.Sprite(utils.spriteFrame("YZDN/num/" + num + ".png"));
    ...
    {
        if (WZDNModel.isMySeatID(this.seatID))
        {
            if(this.sec <= 5)
            {
                if(this.sec == 5)
    ...
    {
        this.seatID = seatID;
        this.player = WZDNModel.getPlayerBySeatID(seatID);
        if(this.player == null)
        {
        ...
        this.m_pAvatar = utils.createCircleAvatar(this.player.avatar, "wznn/res/pic/p_bg.png", "wznn/res/pic/p_bg.png", cc.size(92,92));
...
var WZDNPlayers =
{
    ...
    init:function()
    {
        ...
        for(var i =0 ; i < 5;++i)
        {
            this.players[i] = utils.clone(WZDNPlayer);
