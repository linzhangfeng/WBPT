...
var WZDNCards =
{
        ...
        var card_cend = cc.callFunc(function(){
                   ...
                   if(this.cardNums == 0)
                   {
                       ...
                       var show_z = cc.callFunc(function(){
                            var z_seat = WZDNModel.dealer;
                            var z_pos = WZDNModel.getPosBySeatID(z_seat);
                            var _pos = WZDNPlayers.players[z_pos].getzangPos();
    ...
    showfixMyCards:function(pos,mycards,spellCards,cardtype,delay)
    {
         ...
         (function(self,pos,mycards,spellCards,cardtype,delay)
        {
            ...
            var SCardType = cc.callFunc(function(){
             ...
             self.uiNode.runAction(cc.sequence(Tdelay,SAllCards,cc.delayTime(0.5),SCardType));
        })(this,pos,mycards,spellCards,cardtype,delay);
    ...
    showfixOtherCards:function(pos,spellCards,cardtype,delay)
    {
        ...
        (function(self,pos,spellCards,cardtype,delay)
        {
            var Tdelay = cc.delayTime(delay);
            var players = utils.findNode(self.uiNode.getParent(),"players");
            var SAllCards = cc.callFunc(function(){
            ...
            self.uiNode.runAction(cc.sequence(Tdelay,SAllCards,cc.delayTime(0.5),SCardType));
        })(this,pos,spellCards,cardtype,delay);
    ...
    removeSpeCardT:function(pos)
    {
        var cardTypeBg = this.uiNode.getChildByTag(CardTagUM.ALLCARDTYPEBEGIN + this.player_cards_type*pos);
        if(cardTypeBg)
        {
          cardTypeBg.removeAllChildren(true);
          this.uiNode.removeChild(cardTypeBg);
    ...
    showCardType:function(pos,index,type,flag)
    {
        ...
        var cardType = null;
        cardType = cc.Sprite(utils.spriteFrame("YZDN/CardType/"+type+".png"));
    ...
    reverseAllCards:function(pos,delay)
    {
        (function(pos,delay,self)
        {
            ...
            Tnode.runAction(cc.sequence(cc.delayTime(delay),cc.callFunc(function(){
                         var length = WZDNModel.otherPlayCards[pos].length + 2;
                            for(var i = 0;i < length;i++)
                            {
