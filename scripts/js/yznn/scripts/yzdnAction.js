var YZDNAction =
{
    ...
    init:function()
    {
        ...
        this.getUI("btn_one").getChildByName("num").ignoreContentAdaptWithSize(true);
        this.outBtns.push(this.getUI("btn_one"));
        this.getUI("btn_two").getChildByName("num").ignoreContentAdaptWithSize(true);
        this.outBtns.push(this.getUI("btn_two"));
        this.getUI("btn_three").getChildByName("num").ignoreContentAdaptWithSize(true);
        this.outBtns.push(this.getUI("btn_three"));
        this.getUI("btn_four").getChildByName("num").ignoreContentAdaptWithSize(true);
        this.outBtns.push(this.getUI("btn_four"));
        this.getUI("btn_five").getChildByName("num").ignoreContentAdaptWithSize(true);
    ...
    showOutCardBtnsVideo:function(isQ)
    {
        var useBtns = null;
        if(isQ)
        {
    ...
    hideOutCardBtnsVideo:function(isq)
    {
        var useBtns = null;
        if(isq)
        {
