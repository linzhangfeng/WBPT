...
#include "proto/msg/DelMessageRequestBuf.pb.h"
#include "proto/msg/FastChatInfoBuf.pb.h"
#include "proto/msg/GroupJoinRequestBuf.pb.h"
#include "proto/msg/GroupMessageBuf.pb.h"
#include "proto/msg/GroupRequestBuf.pb.h"
#include "proto/msg/HeartBuf.pb.h"
#include "proto/msg/MessageInfoBuf.pb.h"
#include "proto/msg/NoticeBuf.pb.h"
#include "proto/msg/UnReadInfoBuf.pb.h"
#include "proto/msg/UnReadMessageInfoBuf.pb.h"
...
enum client_action
{
    ...
    PLAYER_ALLIN_COMPARE	        = 2007,       /* all in */
};
...
enum server_command
{
    ...
    SERVER_GET_GUIPAI = 5019,//牌局开始后，显示鬼牌
    SERVER_GET_CHAOZHUANG = 5025,//是否触发抄庄
    SERVER_FLOWER_HAND_CARD      = 5026,  //发第一手牌后补花
    SERVER_GET_HUA_CARD          = 5027,  //游戏过程中摸到花牌
    SERVER_SEND_MESSAGE			 = 5028,//发送提示消息
    
    SERVER_START_PIAO			 = 5024,//开始选择飘（四川麻将）
    SERVER_BROAD_PIAO			 = 5022,//广播玩家选择的飘（四川麻将）
    SERVER_BROAD_LISTENTYPE		 = 5023,//广播玩家选择的听牌类型（四川麻将）
...
enum mj_server {
    ...
    CLIENT_MJ_CHOOSE_PIAO		 = 1108, //选择飘（四川麻将）
    CLIENT_MJ_LISTEN_TYPE		 = 1109, //玩家选择听牌（四川麻将）
