...
#ifndef CreateMatchLayer_hpp
#define CreateMatchLayer_hpp
...
class  CreateMatchLayer: public BaseLayer, public cocos2d::ui::EditBoxDelegate
{
    
public:

    virtual bool init();
    CREATE_FUNC(CreateMatchLayer);
